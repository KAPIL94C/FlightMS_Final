...
public class AirportRestController {
    ...
    public ResponseEntity<String> handleAirportNotFound(InvalidAirportCodeException ex) {
    ...
    public ResponseEntity<String> handleArgumentException(InvalidArgumentException ex) {
